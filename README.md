...
<a href="https://libraryos.live">
  <img src="docs/showcase/hero.webp" alt="LibraryOS landing — 'The Operating System for Modern Libraries' hero headline with 'Get Started Free' and 'Browse Catalog' CTAs on a light grid background with green accent text" width="100%">
</a>

![Demo: LibraryOS walk-through — hero landing page, scroll to 10K+ books and 500+ organizations stats, then transition to the Create Account registration form with split green-gradient layout](docs/showcase/demo.gif)

<details>
<summary>📝 Get started — Create your account</summary>

<img src="docs/showcase/register.webp" width="100%" alt="LibraryOS registration — split layout with green gradient panel 'Start Your Journey with LibraryOS' listing access to thousands of books, create or join organizations, track reading history; form with Username, Full Name, Email, Password fields and Create Account button">
...
<img src="docs/showcase/mobile-hero.webp" width="390" alt="LibraryOS on mobile — 'The Operating System for Modern Libraries' hero with 'Get Started Free' and 'Browse Catalog' buttons, Secure & Private / Lightning Fast / Team Ready trust badges">
